...
go
ALTER database db_aa59a5_aplikacijazaucenje set single_user with
rollback immediate;
go
ALTER database db_aa59a5_aplikacijazaucenje COLLATE croatian_CI_AS;
GO
Alter database db_aa59a5_aplikacijazaucenje set multi_user;
go
SELECT name, collation_name FROM sys.databases;
go
